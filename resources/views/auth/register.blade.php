            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group{{ $errors->has('nama') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" placeholder="{{ __('Nama') }}" name="nama" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}">
                    ...
                    <div class="input-group{{ $errors->has('password_confirmed') ? ' has-danger' : '' }}">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="tim-icons icon-lock-circle"></i>
                            </div>
                        </div>
                        <input type="password" placeholder="{{ __('Konfirmasi Password') }}" name="password_confirmed" class="form-control{{ $errors->has('password_confirmed') ? ' is-invalid' : '' }}">
                        @include('alerts.feedback', ['field' => 'password_confirmed'])
                    </div>
                    <div class="input-group{{ $errors->has('position') ? 'has-danger' : '' }}">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="tim-icons icon-bag-16"></i>
                            </div>
                        </div>
                        <select id="pilih_posisi" placeholder="{{ __('Posisi') }}" name="position" class="form-control{{ $errors->has('position') ? 'is-invalid' : '' }}">
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-left">
                        <h6>
                            <a href="/Login" class="link footer-link">{{ __('Login') }}</a>
                        </h6>
                    </div>
